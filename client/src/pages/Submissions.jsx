...
export default function Submissions() {
  ...
  const fetchSubmissions = async () => {
    try {
      setLoading(true);
      const res = await axios.get(`${import.meta.env.VITE_API_URL}/assignments/instructor/submissions`, {
                    ...
                    <div className="mt-4 space-y-3">
                      ...
                      {submission.fileUrl && (
                        <div>
                          ...
                          <a
                            href={submission.fileUrl.startsWith('http') ? submission.fileUrl : `${import.meta.env.VITE_API_URL.replace('/api', '')}${submission.fileUrl}`}
                            target="_blank"
